...
from backend.models import AgentTrace, Message
from backend.services.chat.session import save_pydantic_history
...
async def persist_turn(
    ...
    if not state.cancelled and not deps.pending_event_ids:
        from backend.services.review import background_memory_review
