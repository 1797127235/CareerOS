...
from backend.services.chat.lock import ConversationLock, LockCapacityError
from backend.services.chat.persistence import _log_task_error, persist_turn, save_user_message
from backend.services.chat.session import ensure_conversation, load_pydantic_history
...
async def stream_chat(
    ...
    if conv.message_count >= 30 and conv.message_count % 10 == 0:
        from backend.services.summary import summarize_background
